...
"""
            ...
            if has_extreme_metrics:
                ...
                system_prompt += (
                    ...
                    "2. **NO PUNS ABOUT YOUR NAME**: Do NOT make puns, jokes, or references based on your own name. If your name has a word in it, don't theme your responses around that word.\n"

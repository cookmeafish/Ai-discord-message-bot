...
"""
            ...
            if has_extreme_metrics:
                ...
                system_prompt += (
                    ...
                    "   - Your name is just a NAME - it does NOT define your vocabulary, metaphors, or puns!\n"
                    "   - NEVER use words, verbs, or imagery associated with whatever your name literally means\n"
                    "   - If someone asks 'how are you?', respond normally - don't theme it around your name\n"
                    "   - Treat your name as arbitrary - like a human named 'Rose' doesn't constantly talk about flowers\n"
